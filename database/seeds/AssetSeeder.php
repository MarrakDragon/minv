...
{ 
    ...
    protected function makeRandomLocatedAsset($location = null, $room = null, $container=null)
    {
    ...
    */
    public function run()
    {
        ...
        // Location 1 
        for ($i = 1; $i<=3; $i++){
            $this->makeRandomLocatedAsset(1, 1, $i);
        }
        
        // Location 1, new rooms
        for ($i = 1; $i<=3; $i++){
            $this->makeRandomLocatedAsset(1, $i, 1);
        }

        // Location 3, new containers and rooms
        for ($i = 1; $i<=5; $i++){
            $this->makeRandomLocatedAsset(3, $i, $i-2);
        }
    }
}
